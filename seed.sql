insert into members (first_name, last_name, user_name, gender, email, gender_orientation, password, createdAt, updatedAt)
values("Pete", "Johnson", "Pete_Johnson", 1, "PJ@email.com", 2, "Password1", now(), now()),
("Darcy", "Emerson", "Darcy_Emerson", 2, "DE@email.com", 1, "Password2", now(), now()),
("Nala", "Wade", "Nala_Wade", 2, "NW@emial.com", 1, "Password3", now(), now()),
("Carmen", "Southern", "Carmen_Southern", 2, "CS@email.com", 1, "Password4", now(), now()),
("Rowan", "Horner", "Rowan_Horner", 1, "RH@email.com", 2, "Password5", now(), now()),
("Jonah", "Dowling", "Jonah_Dowling", 1, "JD@email.com", 2, "Password6", now(), now()),
("Colton", "Noel", "Colton_Noel", 1, "CN@email.com", 2, "Password7", now(), now()),
("Griff", "Guy", "Griff_Guy", 1, "GG@email.com", 2, "Password8", now(), now()),
("Tess", "Carroll", "Tess_Carroll", 2, "TC@email.com", 1, "Password9", now(), now()),
("Elana", "Connor", "Elana_Connor", 2, "EC@email.com", 1, "Password10", now(), now()); 
